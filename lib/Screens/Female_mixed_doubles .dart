...
class MixedWomenScreen extends StatefulWidget {
  const MixedWomenScreen({super.key});

  @override
  _MixedWomenScreenState createState() => _MixedWomenScreenState();
}

class _MixedWomenScreenState extends State<MixedWomenScreen> {
