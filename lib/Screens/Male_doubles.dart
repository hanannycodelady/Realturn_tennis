...
class DoublesMenScreen extends StatefulWidget {
  const DoublesMenScreen({super.key});

  @override
  _DoublesMenScreenState createState() => _DoublesMenScreenState();
}

class _DoublesMenScreenState extends State<DoublesMenScreen> {
